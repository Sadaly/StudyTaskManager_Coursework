...
{
    internal sealed class SystemRoleDeleteCommandHandler : DeleteByIdCommandHandler<SystemRole>
    {
        private readonly IUnitOfWork _unitOfWork;
        private readonly ISystemRoleRepository _systemRoleRepository;

        public SystemRoleDeleteCommandHandler(IUnitOfWork unitOfWork, ISystemRoleRepository systemRoleRepository) : base(unitOfWork, systemRoleRepository)
        {
