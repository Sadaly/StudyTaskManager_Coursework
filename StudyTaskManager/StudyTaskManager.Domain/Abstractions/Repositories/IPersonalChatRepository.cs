...
namespace StudyTaskManager.Domain.Abstractions.Repositories
{
    public interface IPersonalChatRepository : Generic.IRepositoryWithID<PersonalChat>
    {
        ...
        /// <summary>
        /// Возвращает список всех чатов (уже созданных), в котором присутствует пользователь.
        /// </summary>
        public Task<Result<List<PersonalChat>>> GetChatByUserAsync(User user, CancellationToken cancellationToken = default);

        /// <summary>
        /// Возвращает список части чатов (уже созданных), в котором присутствует пользователь.
        /// </summary>
        public Task<Result<List<PersonalChat>>> GetChatByUserAsync(int startIndex, int count, User user, CancellationToken cancellationToken = default);
    }
}
